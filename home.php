...
<body class="html" data-header="light" data-footer="light" data-header_align="app" data-menu_type="left"
        ...
        <li class="lvl1">
          <div class="waves-effect index">
            <a href="sub-components.html">
              ...
              <span class="title">Drumbell</span></a>
          </div>
        </li>
        <li class="lvl1">
          <div class="waves-effect index">
            <a href="sub-components.html">
              <i class="mdi mdi-flask-outline"></i>
              <span class="title">Education</span></a>
          </div>
        </li>
        <li class="lvl1">
          <div class="waves-effect index">
            <a href="sub-components.html">
              <i class="mdi mdi-flask-outline"></i>
              <span class="title">Kids stories</span></a>
          </div>
        </li>
        <li class="sep-wrap">
      ...
      <ul class="collapsible">
        ...
        <li class="lvl1 footer">
          <div class="waves-effect appsettings" data-type="footer" data-value="colored">
            <a href="#!">
              <i class="mdi mdi-checkbox-blank-outline"></i>
              <span class="title">Colored Footer</span>
            </a>
          </div>
        </li>
        <li class="sep-wrap">
        ...
        <li class="lvl1 footer_type">
          <div class="waves-effect appsettings active" data-type="footer_type" data-value="left">
            <a href="#!">
              <i class="mdi mdi-checkbox-blank-outline"></i>
              <span class="title">Left Aligned Footer</span>
            </a>
          </div>
        </li>
        <li class="lvl1 footer_type">
        ...
        <li class="lvl1 footer_menu">
          <div class="waves-effect appsettings active" data-type="footer_menu" data-value="show">
            <a href="#!">
              <i class="mdi mdi-checkbox-intermediate"></i>
              <span class="title">Show Fixed Footer Menu</span>
            </a>
          </div>
        </li>
        <li class="lvl1 footer_menu">
        ...
        <li class="lvl1 footer_menu_style">
          <div class="waves-effect appsettings active" data-type="footer_menu_style" data-value="light">
            <a href="#!">
              <i class="mdi mdi-checkbox-intermediate"></i>
              <span class="title">Light Fixed Menu</span>
            </a>
          </div>
        </li>
        <li class="lvl1 footer_menu_style">
  ...
  <div class="content-area">
    <div class="carousel carousel-fullscreen carousel-slider home_carousel">
      ...
      <a class="carousel-item" href="#carousel-slide-1!">
        ...
        <div class="item-content left-align white-text">
          ...
          <h5 class="light white-text">
            Designed as one our of best mobile app.
          </h5>
        </div>
      </a>
    ...
    <div class="container">
        ...
        <div class="row ui-mediabox  prods prods-boxed equal-height ">
          <div class="col s6 ">
            ...
            <div class="prod-info  boxed z-depth-1">
              ...
              <span class="small brand">Yoga</span>
          ...
          <div class="col s6 ">
            <div class="prod-img-wrap">
              <a class="img-wrap" href="https://wap.guruhub.tech/yoga/video/drumbell/day1/day1_1.mp4"
                data-fancybox="images" data-caption="Home Decor Balls">
                <img alt="image" class="z-depth-1" style="width: 100%;" src="video/img/drumbell/banner.png">
              </a>
            </div>
            <div class="prod-info  boxed z-depth-1">
              <a href="ui-app-products-view.html">
          ...
          <!-- <div class="col s6 ">
            <div class="prod-img-wrap">
              <a class="img-wrap" href="#" data-fancybox="images"
                ...
                <img alt="image" class="z-depth-1" style="width: 100%;" src="assets/images/product-3.jpg">
              </a>
            </div>
            <div class="prod-info  boxed z-depth-1">
              <a href="ui-app-products-view.html">
                <h5 class="title truncate">Education</h5>
              </a> <span class="small brand">Kumon</span>
              <div class="spacer-line"></div>
              <div class="spacer-line"></div>
              <div class="spacer-line"></div>
          ...
          <div class="col s6 ">
            <div class="prod-img-wrap">
              <a class="img-wrap" href="#" data-fancybox="images"
                ...
                <img alt="image" class="z-depth-1" style="width: 100%;" src="assets/images/product-4.jpg">
              </a>
            </div>
            <div class="prod-info  boxed z-depth-1">
              <a href="ui-app-products-view.html">
                <h5 class="title truncate">Kids stories</h5>
              </a> <span class="small brand">Kids</span>
              <div class="spacer-line"></div>
              <div class="spacer-line"></div>
              <div class="spacer-line"></div>
              <span class="addtocart btn-small">Subscribe</span>
      ...
      <footer class="page-footer center primary-bg white-text footer-ex social-colored">
        <div class="container footer-content">
          <div class="row">
            <div class="">
              <h5 class="logo">GURUHUB</h5>
            </div>
            <div class="link-wrap">
              <ul class="link-ul">
                <li>
                  <a class="" href="#!"><i class="mdi mdi-phone"></i> +254774812586</a>
                </li>
                <li>
                  <a class="" href="#!"><i class="mdi mdi-email"></i> info@guruhub.tech</a>
                </li>
                <li>
                  <a class="" href="#!"><i class="mdi mdi-map-marker"></i>Vision Plaza, Mombasa Road</a>
                </li>
              </ul>
        ...
        <div class="footer-copyright">
          <div class="container">
            &copy; Copyright
            <a class="" href="https://guruhub.tech">Guruhub</a>. All rights reserved.
          </div>
        </div>
      </footer>

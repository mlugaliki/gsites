...
<body class="   isfullscreen  html" data-header="light" data-footer="light" data-header_align="app"
...
<div class="content-area">
    <div class="login-bg access-500"></div>
    <div class="container login-area error-page 500">
        <div class="section">
            <div class="row center">
                <h1 class="white-text center error-code">500</h1>
                <div class="spacer"></div>
                <div class="spacer"></div>
                <h6 class="white-text center">Oops! Some technical error noticed. Please try again.</h6>
                <div class="spacer"></div>
                <div class="spacer"></div>
